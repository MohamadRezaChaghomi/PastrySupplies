...
const SocialAndEmail = () => (
  <div className="social-email">
    ...
    <div className="social-icons">
      ...
      <TelegramIcon sx={{ fontSize: 38 }} />
      <InstagramIcon sx={{ fontSize: 38 }} />
    </div>
    <h5 className="text-social-email">با ثبت ایمیل، از جدید ترین تخفیف ها باخبر شوید</h5>
    <form className="form-email d-flex align-items-center justify-content-end">
      <input className="email-form-input" type="email" placeholder="ایمیل شما" />
      <button className="email-submit-btn" type="submit">ثبت</button>
    </form>
  </div>
);
