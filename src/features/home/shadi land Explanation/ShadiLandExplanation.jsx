    ...
    <div className="d-flex align-content-center justify-content-center">
      <div className="about-shadiland" ref={sectionRef}>
        ...
        <p className="about-shadiland__text">
          شادی‌لند یک فروشگاه اینترنتی تخصصی در زمینه فروش لوازم تولد، تزئینات
          جشن و خدمات بادکنک‌آرایی است. که با هدف ساختن لحظاتی شاد و خاطره‌انگیز
          برای شما و عزیزانتان راه‌اندازی شده است. در شادی‌لند مجموعه‌ای کامل از
          انواع بادکنک‌ها، تم‌های تولد کودکانه، بادکنک‌های فویلی و هلیومی، و
          وسایل تزئینی برای مجالس متنوع گردآوری شده تا بتوانید در کمترین زمان
          بهترین انتخاب را داشته باشید. ما تلاش می‌کنیم تا با ارائه خدمات
          باکیفیت، محصولات متنوع و قیمت‌های مناسب، تجربه‌ای راحت، سریع و
          هیجان‌انگیز از برگزاری جشن‌ها برای شما فراهم کنیم.
        </p>
      </div>
    </div>
  );
