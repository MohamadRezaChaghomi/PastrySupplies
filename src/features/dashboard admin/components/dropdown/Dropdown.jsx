...
export default function Dropdown() {
    ...
    const isActive = ["/category", "/category/create", "/product/create"].includes(location.pathname);
        ...
        <div className={`dropdown ${open ? "open" : ""}`} onMouseLeave={() => setOpen(false)}>
            ...
            {open && (
                <ul className="dropdownMenu">
                    <li>
                        <Link to="/category" className={`dropdownItem ${location.pathname === "/category" ? "active" : ""}`} onClick={handleItemClick}>
                            <CategoryOutlinedIcon className="sidebarIcon" />
                            <span className="itemLabel">دسته‌بندی ها</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/category/create" className={`dropdownItem ${location.pathname === "/category/create" ? "active" : ""}`} onClick={handleItemClick}>
                            <AddCircleOutlineOutlinedIcon className="sidebarIcon" />
                            <span className="itemLabel">ایجاد دسته‌بندی</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/product/create" className={`dropdownItem ${location.pathname === "/product/create" ? "active" : ""}`} onClick={handleItemClick}>
                            <AddCircleOutlineOutlinedIcon className="sidebarIcon" />
